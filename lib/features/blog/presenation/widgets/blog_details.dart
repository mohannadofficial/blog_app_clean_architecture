...
class BlogDetails extends StatefulWidget {
  final Blog? blog;
  const BlogDetails({super.key, this.blog});
...
class _BlogDetailsState extends State<BlogDetails> {
  ...
  void initState() {
    ...
    if (widget.blog != null) {
      blogTitleController.text = widget.blog?.title ?? '';
      blogDescriptionController.text = widget.blog?.content ?? '';
      ...
      child: Scaffold(
        appBar: AppBar(
          ...
          actions: [
            IconButton(
              onPressed: () =>
                  widget.blog != null ? editBlog(widget.blog!) : addNewBlog(),
              icon: Icon(
                widget.blog != null ? Icons.edit_rounded : Icons.done_rounded,
              ),
            )
          ],
        ),
